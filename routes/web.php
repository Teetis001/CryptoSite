...
|
*/
Route::get('/', [NonAuthController::class, 'index'])->name('home');
Route::get('/about', [NonAuthController::class, 'about'])->name('about');
Route::get('/services', [NonAuthController::class, 'services'])->name('services');
Route::get('/trading', [NonAuthController::class, 'trading'])->name('trading');
Route::get('/pricing', [NonAuthController::class, 'pricing'])->name('pricing');
Route::get('/faq', [NonAuthController::class, 'faq'])->name('faq');
...
Route::middleware('auth')->group(function() {
    ...
    Route::controller(PageController::class)->group(function() {
        Route::get('/dashboard-one', 'dashboardOverview1')->name('dashboard-overview-1');
