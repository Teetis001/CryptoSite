...
<head>
    ...
    <meta charset="utf-8" />
    <title>Services - MayorExchange Bitcoin/Giftcard Crypto Currency</title>
					...
					<div class="col-md-6 service-box">
						<div>
							...
							<div class="service-box-content">
								...
								<p>This is a mediator service that keeps the money for a transaction in safekeeping until the Bitcoins are paid to. </p>
							</div>
						</div>
					</div>
					<!-- Service Box Ends -->
					...
					<div class="col-md-6 service-box">
						<div>
							...
							<div class="service-box-content">
								...
								<p> When a bitcoin is successfully mined, the miner receives a predetermined amount of bitcoin.</p>
							</div>
						</div>
					</div>
					<!-- Service Box Ends -->
					...
					<div class="col-md-6 service-box">
						<div>
							...
							<div class="service-box-content">
								<h3>Gift Cards</h3>
								<p>
 You load money onto the card, which you or the gift card's recipient can then spend at accepted locations. Some prepaid gift cards charge a fee to purchase them</p>
							</div>
						</div>
					</div>
					<!-- Service Box Ends -->
					...
					<div class="col-md-6 service-box">
						<div>
							...
							<div class="service-box-content">
								...
								<p>All Bitcoin transactions are public, traceable, and permanently stored in the Bitcoin network. ... Anyone can see the balance and all transactions of any address</p>
							</div>
						</div>
					</div>
					<!-- Service Box Ends -->
					...
					<div class="col-md-6 service-box">
						<div>
							...
							<div class="service-box-content">
								...
								<p>The prices of cryptocurrencies are highly volatile, which means that they're highly risky.” That said, most financial advisors say there's little harm.</p>
							</div>
						</div>
					</div>
					<!-- Service Box Ends -->
