...
<head>
    ...
    <meta charset="utf-8" />
    <title>Index- MayorExchange Giftcard/Bitcoin Crypto Currency</title>
    ...
    <div class="wrapper">
        ...
        <div id="main-slide" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="item active bg-parallax item-1" style="background-image:url({{url('/images/bitcoin.jpg')}})">
                    <div class="slider-content">
                        <div class="container">
                            <div class="slider-text text-center">
                                <h3 class="slide-title"><span>Secure</span> and <span>Easy Way</span><br/> To Bitcoin</h3>
                                <p>
                                    <a href="about.html" class="slider btn btn-primary">Trade with Us on Whatsapp Now</a>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Carousel Item Ends -->
                <!-- Carousel Item Starts -->
                <div class="item bg-parallax item-2" style="background-image:url({{url('/images/cards.jpg')}})">
                    <div class="slider-content">
                        <div class="col-md-12">
                            <div class="container">
                                <div class="slider-text text-center">
                                    <h3 class="slide-title"><span> Gift Cards</span> Exchange to Naira<br/>You can <span>Trust</span> </h3>
                                    <p>
                                        <a href="{{route('pricing')}}" class="slider btn btn-primary">Click here to Register</a>
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row features-row">
                    ...
                    <div class="feature-box col-md-4 col-sm-12">
                        <span class="feature-icon">
							<img src="{{ asset('/images/icons/orange/download-bitcoin.png') }}" alt="download bitcoin">
						</span>
                        <div class="feature-box-content">
                            <h3>Reliable Crypto Trading</h3>
                            <p>Mayor Exchange is a professional team that provide professional itunes cards services, send and receive bitcoins.</p>
                        </div>
                    </div>
                    <!-- Feature Box Ends -->
                    <!-- Feature Box Starts -->
                    <div class="feature-box two col-md-4 col-sm-12">
                        <span class="feature-icon">
							<img src="{{asset('images/icons/orange/add-bitcoins.png')}}" alt="add bitcoins">
						</span>
                        <div class="feature-box-content">
                            <h3>Trade Bitcoin to your Wallet</h3>
                            <p>Exchange Bitcoin to Naira.</p>
                        </div>
                    </div>
                    <!-- Feature Box Ends -->
                    <!-- Feature Box Starts -->
                    <div class="feature-box three col-md-4 col-sm-12">
                        <span class="feature-icon">
							<img src="{{asset('images/icons/orange/buy-sell-bitcoins.png')}}" alt="buy and sell bitcoins">
						</span>
                        <div class="feature-box-content">
                            <h3>Buy all kinds of Gift Cards</h3>
                            <p>Enter Accounts, specify the amount, upload card details and send.</p>
                        </div>
                    </div>
                    <!-- Feature Box Ends -->
                </div>
            ...
            <div class="container">
                ...
                <div class="row text-center">
                    ...
                    <div class="title-head-subtitle">
                        <p>A commercial website that sells Cards, exchanges and other bitcoin related info</p>
                    </div>
                </div>
                <!-- Section Title Ends -->
                ...
                <div class="row about-content">
                    ...
                    <div class="col-sm-12 col-md-5 col-lg-6 text-center">
                        <img class="img-responsive img-about-us" src="{{asset('/images/card-bit.jpg')}}" alt="about us">
                    </div>
                    <!-- Image Ends -->
                    <!-- Content Starts -->
                    <div class="col-sm-12 col-md-7 col-lg-6">
                        <h3 class="title-about">WE ARE MAYOR EXCHANGE</h3>
                        <p class="about-text">A place for everyone who wants to simply sell Bitcoins/Gift Cards. Get paid in less than 40mins through bank transfer. Instant sell of Bitcoins/Gift Cards at fair price is guaranteed. Nothing extra. Join over 700,000 users from all over the world satisfied with our services.</p>
                    ...
                    <div class="col-md-8 ts-padding img-block-left">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-6 col-xs-12">
                                <div class="feature text-center">
                                    <span class="feature-icon">
										<img src="{{asset('images/icons/orange/strong-security.png')}}" alt="strong security"/>
									</span>
                            ...
                            <div class="col-sm-6 col-md-6 col-xs-12">
                                <div class="feature text-center">
                                    <span class="feature-icon">
										<img src="{{asset('images/icons/orange/world-coverage.png')}}" alt="world coverage"/>
									</span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-6 col-xs-12">
                                <div class="feature text-center">
                                    <span class="feature-icon">
										<img src="{{asset('images/icons/orange/payment-options.png')}}" alt="payment options"/>
									</span>
                            ...
                            <div class="col-sm-6 col-md-6 col-xs-12">
                                <div class="feature text-center">
                                    <span class="feature-icon">
										<img src="{{asset('images/icons/orange/mobile-app.png')}}" alt="mobile app"/>
									</span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-6 col-xs-12">
                                <div class="feature text-center">
                                    <span class="feature-icon">
										<img src="{{asset('images/icons/orange/cost-efficiency.png')}}" alt="cost efficiency"/>
									</span>
                            ...
                            <div class="col-sm-6 col-md-6 col-xs-12">
                                <div class="feature text-center">
                                    <span class="feature-icon">
										<img src="{{asset('images/icons/orange/high-liquidity.png')}}" alt="high liquidity"/>
									</span>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 img-block-quote bg-image-2">
                        <blockquote>
                            ...
                            <footer><img src="{{asset('images/ceo.jpg')}}" alt="ceo" /> <span>Marc Smith</span> - CEO</footer>
                        </blockquote>
                    </div>
                    <!-- Quote Ends -->
                    <!-- Chart Starts -->
                ...
                <div class="row latest-posts-content">
                    ...
                    <div class="col-sm-4 col-md-4 col-xs-12">
                        <div class="latest-post">
                            ...
                            <a href="blog-post.html"><img class="img-responsive" src="{{asset('/images/bitcoin.jpg')}}" alt="img"></a>
                            <!-- Featured Image Ends -->
                    ...
                    <div class="col-sm-4 col-md-4 col-xs-12">
                        <div class="latest-post">
                            <!-- Featured Image Starts -->
                            <a href="blog-post.html"><img class="img-responsive" src="{{asset('/images/apple.jpg')}}" alt="img"></a>
                            <!-- Featured Image Ends -->
                            <!-- Article Content Starts -->
                            <div class="post-body">
                                <h4 class="post-title">
                    ...
                    <div class="col-sm-4 col-md-4 col-xs-12">
                        <div class="latest-post">
                            <!-- Featured Image Starts -->
                            <a href="blog-post.html"><img class="img-responsive" src="{{asset('/images/cards.jpg')}}" alt="img"></a>
                            <!-- Featured Image Ends -->
                            <!-- Article Content Starts -->
                            <div class="post-body">
                                <h4 class="post-title">
