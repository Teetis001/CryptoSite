...
<head>
    ...
    <meta charset="utf-8" />
    <title>ABOUT US - MayorExchange Giftcard/Bitcoin Crypto Currency</title>
...
<body>
    ...
    <div class="wrapper">
        ...
        <!-- Header Ends -->
		<!-- Banner Area Starts -->
		<section class="banner-area" style="background-image:url({{url('/images/abt.png')}})">
            ...
            <div class="container">
                ...
                <div class="row about-content">
                    ...
                    <div class="col-sm-12 col-md-5 col-lg-6 text-center">
                        <img class="img-responsive img-about-us" src="{{ asset('/images/about.jpg') }}" alt="about us">
                    </div>
                    <!-- Image Ends -->
                    <!-- Content Starts -->
                    <div class="col-sm-12 col-md-7 col-lg-6">
						<div class="feature-about">
							...
							<p>A place for everyone who wants to simply sell Bitcoins & Gift Card. Instant sell of Bitcoins/Gift Card at fair price is guaranteed. Nothing extra. Join over 700,000 users from all over the world satisfied with our services.</p>
						</div>
						<div class="feature-about">
							<h3 class="title-about risk-title"><i class="fa fa-warning"></i> Risk Warning</h3>
							<p>Bitcoin/Gift Card is not legal tender and is not backed by any government. Accounts and value balances are not subject to any government backed deposit insurance or any other government protections.</p>
						</div>
